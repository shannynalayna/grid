...
mod test {
    ...
    use crate::database::{
        ...
        models::{NewAgent, NewGridSchema, NewGridPropertyDefinition, NewOrganization},
    ...
    fn populate_property_definition_table(conn: &PgConnection, definitions: &[NewGridPropertyDefinition]) {
    ...
    fn clear_property_definition_table(conn: &PgConnection) {
        ...
        diesel::delete(grid_property_definition).execute(conn).unwrap();
    }
