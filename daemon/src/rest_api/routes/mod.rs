...
mod test {
    ...
    ///
    /// Verifies a GET /organization/{id}?service_id=test responds with NotFound response
    ...
    ///
    /// Verifies a GET /agent/{public_key}?service_id=test responds with an Ok response
    ...
    ///
    /// Verifies a GET /agent/{public_key}?service_id=test responds with a Not Found response
    ...
    /// Verifies a GET /schema?service_id=test responds with an OK response with a
    ///     list_grid_schemas request.
    ///
    ///     The TestServer will receive a request with no parameters,
    ///         then will respond with an Ok status and a list of Grid Schemas.
    ...
    ///
    /// Verifies a GET /schema/{name}?service_id=test responds with an OK response
    ...
    ///
    /// Verifies a GET /schema/{name}?service_id=test responds with a Not Found error
    ...
    /// Verifies a GET /product?service_id=test responds with an OK response with a
    ///     list_products request.
    ///
    ...
    ///
    /// Verifies a GET /product/{id}?service_id=test responds with an OK response
    ...
    ///
    /// Verifies a GET /product/{id}?service_id=test responds with a Not Found error
    ...
    ///
    /// Verifies a GET /record?service_id=test responds with an Ok response
    ...
    ///
    /// Verifies a GET /record/{record_id}?service_id=test responds with a Not Found error
    ///     when there is no Record with the specified record_id.
    ///
    #[actix_rt::test]
    ...
    ///
    /// Verifies a GET /record/{record_id}/property/{property_name}?service_id=test responds
